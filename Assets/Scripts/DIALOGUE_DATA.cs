...
public class DIALOGUE_DATA
{
    ...
    private const string segmentIdentifierPattern = @"\{[ca]\}|\{w[ca]\s\d*\.?\d*\}";//Anything inside here is litteral string @
    ...
    public struct DIALOGUE_SEGMENT
    {
        ...
        public bool appedText => (startSignal == StartSignal.A || startSignal == StartSignal.WA);
    }
}
